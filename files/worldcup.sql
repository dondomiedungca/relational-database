...
--
-- Name: games fk_teams_games1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_teams_games1 FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);


--
-- Name: games fk_teams_games2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_teams_games2 FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
